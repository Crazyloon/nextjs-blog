...
<ImageCredit
  alt="A laptop with code displayed on-screen"
  src="/images/codeoncomputer.jpg"
  author="Joshua Aragon"
  sourceName="Unsplash"
  sourcePageURL="https://unsplash.com/photos/EaB4Ml7C7fE"
/>
...
If I haven't scared you away from learning web development yet, you've probably got what it takes to learn everything you need to know to start building. The roadmap is broken down into a series of blog posts, one for each major topic of discussion. Each major discussion with have a section for you to complete each day. There will be a required assignment and a bonus lesson. You're highly encouraged to complete the bonus content, as willingness to do the extra work is going to put you ahead of other aspiring developers. If you don't find the bonus content interesting or challenging enough, do some research on your own for additional practice - that's another skill you'll need anyway.

Go ahead and [start your journey](/blog/100-days-of-code-html). As always, feel free to leave feedback if you think the roadmap is missing critical information for new developers.
