...
/*private*/ async function getAllPostsData() {
  // const fileNames = fs.readdirSync(postsDirectory);

  const fileNames = await fs.promises.readdir(postsDirectory); //, (err, files) => {

  // if (err) {
  //   throw Exception("Files could not be found");
  // } else {
  //   filesNames = files;
  // }
  // });
...
export async function getFeaturedPosts() {
  const featurePosts = await getSortedPostsData();
