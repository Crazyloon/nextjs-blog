  ...
  return (
    <Link href={`/blog/${slug}`} key={slug}>
      <a className="[&>*>h3]:hover:underline">
        <div className="flex h-[14rem] transform cursor-pointer flex-col rounded-md border border-slate-400 border-opacity-20 p-4 shadow-md shadow-shadow transition-all duration-300 hover:-translate-y-1 hover:border-opacity-10 hover:shadow-lg hover:shadow-shadow lg:h-[16rem] [&>span>svg]:hover:animate-bounceRight">
          <h3>{title}</h3>
